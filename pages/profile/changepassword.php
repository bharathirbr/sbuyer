...
if (isset($_REQUEST['submit'])) {
    ...
    if ($_SESSION['type'] == 'admin') {
        ...
        if ($password == $cpassword) {
            ...
            $resa = $db->prepare("UPDATE `usermaster` SET `password`=? WHERE `uid`=?");
            $resa->execute(array(strtolower(trim($password)),$_SESSION['UID']));
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="password" required="required" class="form-control" placeholder="password" name="password" id="password" min="6" Max="255" value="" />
                            </div>
                            <div class="col-md-6">
