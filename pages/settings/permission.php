...
if (isset($_REQUEST['submit'])) {
    ...
    //$msg = addpermission($division, $order, $status, $ip, $_SESSION['pid']);
}
?>
                ...
                <form name="form1" method="post" action="">
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php
                            $depart = pFETCH("SELECT * FROM `permission` WHERE `status`!=?",2);
                            ...
                            if ($ndepart > 0) {
                                ...
                                <tbody>
                                    ...
                                    while ($fdepart =$depart->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo getpermission('name', $fdepart['pid']); ?></td>
                                            <td width="10%"><?php
                                if ($fdepart['status'] == '1') {
                                    echo 'Active';
                                } else {
                                    echo 'Inactive';
                                        ...
                                        ?></td>
                                            <td align="center" width="10%"><i class="fa fa-edit" onclick="javascript:editthis('<?php echo $fdepart['pid']; ?>');" style="cursor:pointer;"></i></td>
                                            <td align="center" width="10%"><input type="checkbox" name="chk[]" id="chk[]" value="<?php echo $fdepart['pid']; ?>" /></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
