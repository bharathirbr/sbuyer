                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left" width="40%" >Phone Number</th>                                  
                                    <th style="text-align: left" width="45%" >Support Email</th>
                                ...
                                <tbody>
                                    ...
                                    while ($fdepart = $ndepart->fetch()) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left"><?php echo $fdepart['phone']; ?></td>
                                            <td style="text-align: left"><?php echo $fdepart['support_mail']; ?></td>
                                            <td align="center" ><i class="fa fa-edit" onclick="javascript:editthis('<?php echo $fdepart['generalid']; ?>');" style="cursor:pointer;"></i></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
