...
<html lang="en-IN">
    <head>
        <meta charset="UTF-8">
        <title>Vardaan ASTROLIFE | Login</title>
        ...
        <link rel="icon" href="<?php echo $fsitename; ?>images/logo250x250.jpg" type="image/png">
    ...
    <body class="login-page  ">
        <div class="login-box ">
            <div class="login-logo">
                <a href="#"><h1>Vardaan ASTROLIFE</h1></a>
            </div><!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg"><?php
                    if ($msg != '') {
                        ...
                        ?>Sign in to start your session<?php } ?></p>
