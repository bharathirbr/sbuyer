...
?> CMS Pages</small>
        ...
        if ($_REQUEST['stid'] == 1) {
            ...
            echo $title = 'Astrology Services';
        } elseif ($_REQUEST['stid'] == 4) {
            echo $title = 'Numerology';
        } elseif ($_REQUEST['stid'] == 5) {
            echo $title = 'Gemstones';
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" id="delimage">
                                    <label> </label>
<?php if ((getstaticpages('image', $_REQUEST['stid']) != '') && (isset($_REQUEST['stid']))) {
    ?>
