...
if (isset($_REQUEST['submit'])) {
    ...
    if (($imagename1!= $imagename2) && ($imagename1 != $imagename3) && ($imagename2 != $imagename3)) {


        $pimage1 = gethomebanner('image_name1', '1');
        $pimage2 = gethomebanner('image_name2', '1');
        $pimage3 = gethomebanner('image_name3', '1');
        ...
        if (($ext1 == '1') || ($ext2 == '1') || ($ext3 == '1')) {
            ...
            $msg = addhomebanner($title1, $link1, $content1, $imagealt1, $imagename1, $image1, $title2, $link2, $content2, $imagealt2, $imagename2, $image2, $title3, $link3, $content3, $imagealt3, $imagename3, $image3, $ip, $thispageid, $getid);
        }
    } else {
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">                                             
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Image <span style="color:#FF0000;"> *(Recommended Size 675 * 300)</span></label>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Content </label>
                                    <textarea name="content3" id="content1" class="form-control" placeholder="Enter the Content here"><?php echo stripslashes(gethomebanner('content3', $_REQUEST['hbanid'])); ?></textarea>
                                </div>
                            </div>
                            <div class="clearfix"><br /></div>
                            <div class="row">
                            ...
                            <div class="row">                                             
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label>Image <span style="color:#FF0000;"> *(Recommended Size 1380 * 420)</span></label>
