...
if (isset($_REQUEST['delete']) || isset($_REQUEST['delete_x'])) {
    ...
    $chk = $_REQUEST['chk'];
    $chk = implode('.', $chk);
    $msg = $mast->delinnercategory($chk, $thispageid, $ip);
}
?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Inner Category Mgmt
            <small>Manage Inner Category Mgmt</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-product-hunt"></i> Products</a></li>
            <li class="active">Inner Category Mgmt</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>products/addinnercategory.htm">Add New InnerCategory </a></h3><!---->
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
