...
<style type="text/css">
    ...
    #normalexamples tbody tr td:nth-child(2) {
        text-align:left;
         ...
         #normalexamples tbody tr td:nth-child(3),#normalexamples tbody tr td:nth-child(4),#normalexamples tbody tr td:nth-child(5),#normalexamples tbody tr td:nth-child(6),#normalexamples tbody tr td:nth-child(7) {
        text-align:center;
        }
</style>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>master/addfaq.htm">Add New FAQ </a></h3><!---->
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editfaq.htm';
    }
</script>
<!--<script>
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=faqtable"
    });
</script>