...
<style type="text/css">
    ...
    #normalexamples tbody tr td:nth-child(2) {
        text-align:left;
         ...
         #normalexamples tbody tr td:nth-child(3),#normalexamples tbody tr td:nth-child(4),#normalexamples tbody tr td:nth-child(5),#normalexamples tbody tr td:nth-child(6) {
        text-align:center;
        }
</style>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Video Mgmt
            <small>Manag video Mgmt</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-cogs"></i>Master(s)</a></li>
            <li class="active">Video Mgmt</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>master/addvideo.htm">Add New Video </a></h3><!---->
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editvideo.htm';
    }
</script>
<!--<script>
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=videotable"
    });
</script>