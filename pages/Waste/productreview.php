...
if (isset($_REQUEST['delete']) || isset($_REQUEST['delete_x'])) {
    ...
    $chk = $_REQUEST['chk'];
    $chk = implode('.', $chk);
    $msg = delproductreview($chk, $thispageid, $ip);
}
?>
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Productreview(s)"))
            {
                return true;
            } else
            {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Product Review 
            <small>Manage ProductReview Mgmt</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-cogs"></i> Dynamic Pages</a></li>
            <li class="active">Product Review Mgmt</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>products/addproductreview.htm">Add New Product Review </a></h3><!---->
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>products/' + a + '/editproductreview.htm';
    }
</script>
...
//    });
    ...
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=productreviewtable"
    });
</script>