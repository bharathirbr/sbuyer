...
if (isset($_REQUEST['delete']) || isset($_REQUEST['delete_x'])) {
    $chk = $_REQUEST['chk'];
    $chk = implode('.', $chk);
    $msg = delattributegroup($chk,$thispageid);
}
?>
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Attribute Group(s)"))
            {
                return true;
            } else
            {
...
<style type="text/css">
    ...
    #normalexamples tbody tr td:nth-child(1), tbody tr td:nth-child(4), tbody tr td:nth-child(5), tbody tr td:nth-child(6) {
        text-align:center;
    }
</style>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Attribute Group 
            <small>Attribute Group Mgmt</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>products/addattributegroup.htm">Add New  Attribute Group </a></h3><!---->
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>products/' + a + '/editattributegroup.htm';
    }
</script>
<!--<script>
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=attrigrptable"
    });
</script>
