...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
           Print Template(s)
            <small>List of Template(s)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="#" data-toggle="control-sidebar"><i class="fa fa-gear"></i>Settings</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Print Template(s)</a></li>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>settings/' + a + '/editprinttemplate.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.htm?types=printtrmplist"
    });
</script>
