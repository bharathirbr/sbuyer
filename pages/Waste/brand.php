...
if (isset($_REQUEST['delete']) || isset($_REQUEST['delete_x'])) {
    ...
    $chk = $_REQUEST['chk'];
    $chk = implode('.', $chk);
    $msg = delbrand($chk, $thispageid, $ip);
}
?>
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Brand(s)"))
            {
                return true;
            } else
            {
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>master/addbrand.htm">Add New Brand </a></h3>
            </div>
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var sid = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editbrand.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=brandtable"
    });
</script>