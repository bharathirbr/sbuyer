...
if(isset($_POST['saveItemMap']) && $_REQUEST['enquiryid']!=''){     
    $msg = addItemMapEnq($_POST['supplier_selected'],$_POST['prodIds'],'enquiry',$_REQUEST['enquiryid'],$_POST['O_Enq_IM_ids']);
}
if(isset($_REQUEST['CreateRFQ']) && $_REQUEST['enquiryid']!=''){
    $msg = CreateRFQ('enquiry',$_REQUEST['enquiryid'],$_REQUEST['chk']);
}
if(isset($_REQUEST['SendRFQ'])){
    $msg = SendRFQMail('enquiry',$_REQUEST['enquiryid'],$_REQUEST['chk']);
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>process/enquiry_preparation.htm"><i class="fa fa-circle-o"></i>Enquiry</a></li>
            <li class="active"><?php
                if ($_REQUEST['enquiryid'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form name="department" id="department" action="" method="post" enctype="multipart/form-data">
            <div class="box box-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-3" id="suppliermode" >
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control readonly" style='background: #eee;' name="customer" required="required"  value="<?php echo getcustomer('Person', getpurchaseEnquiry('CusID', $_REQUEST['enquiryid'])); ?>"/>
                                        <div class="input-group-addon">
                                ...
                                <div  style="display:none" id="supplierpanel">
                                    <input type="hidden" class="form-control"  name="CusID" id="CusID" required="required"value="<?php echo getpurchaseEnquiry('CusID', $_REQUEST['enquiryid']); ?>"  />   
                                    <div class="col-md-3" >
                                        <label>Customer Name</label>
                                        <div class="input-group date">
                                            <input type="text" class="form-control readonly"  name="customer" id="customesr"  value="" />
                                        ...
                                        if ($_REQUEST['enquiryid'] != '') {
                                            ...
                                            while ($fdepart = $getitemvalue->fetch()) {
                                                ...
                                                <tr valign = "top" id="datarow<?php echo $key; ?>">
                                                    ...
                                                    <td valign="middle"><i class="btn btn-danger fa fa-trash" style="width: 20px;padding: 6px 4px;" name="remove[]" id="remove<?php echo $key; ?>" onclick="remove12('<?php echo $key; ?>')"></i></td>
                                                </tr> 
                                                <?php
                                                $i++;
                                            }
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="<?php echo $sitename; ?>process/enquiry_preparation.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-4">
                            <?php
                            if($_REQUEST['enquiryid']!='' && getpurchaseEnquiry('convert_to_sales_quote', $_REQUEST['enquiryid'])!='1'){  ?>
                            <button type="submit" name="ConvertoSalesQuote" id="ConvertoSalesQuote" class="btn btn-success" style="float:right;">Convert to Sales Quote</button>
                                <?php } ?>
                        </div>
                        <div class="col-md-4">
    ...
    <div id="ItemMapModal" class="modal fade" role="itemmapmodal">
        <div class="modal-dialog modal-lg">
		<form name="Item_map_form" method="post" onsubmit="return checksupselc();">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-footer">
					<button type="submit" name="saveItemMap" disabled="disabled" class="btn btn-success disabled imsave">Save</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            </div>
			</form>
                        ...
                        <table id="itemmapsupp" class="table table-bordered table-striped">
                            <thead>
                                <tr align="center">
									...
									<th style="width:7% ">Last Supplied Date</th>
									<th style="width:7% ">Last Supplied Qty</th>
									<th style="width:5% ">Last Supplied Rate</th>
									<th style="width:2%">Action</th>
                                </tr>
                            </thead>
                            <tbody>
