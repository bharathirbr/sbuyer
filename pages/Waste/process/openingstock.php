...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Opening Stock(s)"))
            {
                return true;
            } else
            {
...
<style type="text/css">
    ...
    #normalexamples tbody tr td:nth-child(7),tbody tr td:nth-child(8) {
     ...
     #normalexamples tbody tr td:nth-child(1), tbody tr td:nth-child(2),tbody tr td:nth-child(5),tbody tr td:nth-child(6),tbody tr td:nth-child(9),tbody tr td:nth-child(10) {
        text-align:center;
    }
</style>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Opening Stock
            <small>List of Opening Stock</small>
        </h1>
        <ol class="breadcrumb">
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>process/' + a + '/editopening_stock.htm';
    }
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.htm?types=opening_stock",
