...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>process/purchase_order.htm"><i class="fa fa-circle-o"></i>Purchase Order</a></li>
            <li class="active"><?php
                if ($_REQUEST['purchid'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form name="department" id="department" action="" method="post" enctype="multipart/form-data">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label>P.O Type <span style="color:#FF0000;"> *</span> </label>
                                    <input type="hidden" name="purmode" value="1" />
                                    <select name="purmodes" onchange="gridmode()" id="purmodes" class="form-control" disabled>

                                        <option value="1" <?php
                                        if (getpurchaseorder('PoType', $_REQUEST['purchid']) == '1') {
                                            echo 'selected';
                                        }
                                        ?>>Supplier Based</option>
                                        <option value="2" <?php
                                        if (getpurchaseorder('PoType', $_REQUEST['purchid']) == '2') {
                                            echo 'selected';
                                        }
                                ...
                                <div class="col-md-3">
                                    <label>P.O Date<span style="color:#FF0000;"> *</span></label>
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" class="form-control pull-right usedatepicker" name="billdate" required="required"  value="<?php
                                        if (isset($_REQUEST['purchid']) && ( date('d-m-Y', strtotime(getpurchaseorder('PODate', $_REQUEST['purchid']))) != '01-01-1970')) {
                                            echo date('d-m-Y', strtotime(getpurchaseorder('PODate', $_REQUEST['purchid'])));
                                        }
                                        ?>" >
                                    </div>
                                </div>
                                <!-- Tax type takened from customer -->
                                <div class="col-md-3" style="display: none;" description="it was takened from customer. dont use this">
                                    <label>Tax Type <span style="color:#FF0000;"> *</span>
                                    </label>
                                    <select name="taxtype" id="taxtype" class="form-control" onchange="univaerselcha()">
                                        <option value="0" <?php
                                        if (getpurchaseorder('TaxType', $_REQUEST['purchid']) == '0') {
                                            echo 'selected';
                                        }
                                        ?>>No Tax</option>
                                        <option value="1" <?php
                                        if (getpurchaseorder('TaxType', $_REQUEST['purchid']) == '1') {
                                            echo 'selected';
                                        }
                                        ?>>Inclusive Tax</option>
                                        <option value="2" <?php
                                        if (getpurchaseorder('TaxType', $_REQUEST['purchid']) == '2') {
                                            echo 'selected';
                                        }
                                        ?>>Excluded Tax</option>
                                    </select>
                            ...
                            <div class="row" id="suppliermode121">
                               
                                <div  style="display:none" id="supplierpanel">
                                    <div class="col-md-3" >
                                        <label>Supplier Name</label>
                                        <div class="input-group date">
                                            <input type="text" readonly class="form-control"  name="supplier" id="supplier" required="required" value="" />
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <label>Delivery Terms <span style="color:#FF0000;"> *</span></label>
                                    <select name="deliveryterms" id="deliveryterms" required="required" class="form-control">
                                        <option value="">Select</option>
                                        <?php
                                        $dterms = $db->prepare("SELECT * FROM `deliveryterm` WHERE `Status`=?");
                                        $dterms->execute(array('1'));
                                        while ($fdepart = $dterms->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $fdepart['DTID']; ?>"
                                            <?php
                                            if ($fdepart['DTID'] == getpurchaseorder('Deliveryterms', $_REQUEST['purchid'])) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo $fdepart['DeliveryTerm']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <label>Mode of Shipment<span style="color:#FF0000;"> *</span></label>
                                    <select name="modeofshipment" id="modeofshipment" required="required" class="form-control">
                                        <option value="">Select</option>
                                        <?php
                                        $dterms = $db->prepare("SELECT * FROM `shipment` WHERE `Status`=?");
                                        $dterms->execute(array('1'));
                                        while ($fdepart = $dterms->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $fdepart['MSID']; ?>"
                                            <?php
                                            if ($fdepart['MSID'] == getpurchaseorder('Modeofshipment', $_REQUEST['purchid'])) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo $fdepart['Shipment']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <label>Mode of Payment <span style="color:#FF0000;"> *</span></label>
                                    <select name="modeofpayment" id="modeofpayment" required="required" class="form-control">
                                        <option value="">Select</option>
                                        <?php
                                        $dterms = $db->prepare("SELECT * FROM `payment` WHERE `Status`=?");
                                        $dterms->execute(array('1'));
                                        while ($fdepart = $dterms->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $fdepart['MPID']; ?>"
                                            <?php
                                            if ($fdepart['MPID'] == getpurchaseorder('Modeofpayment', $_REQUEST['purchid'])) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo $fdepart['Payment']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <label>Enquiry Currency <span style="color:#FF0000;"> *</span></label>
                                    <select name="enquirycurrency" id="enquirycurrency" required="required" class="form-control">
                                        <option value="">Select</option>
                                        <?php
                                        $dterms = $db->prepare("SELECT * FROM `currency` WHERE `Status`=?");
                                        $dterms->execute(array('1'));
                                        while ($fdepart = $dterms->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $fdepart['CID']; ?>"
                                            <?php
                                            if ($fdepart['CID'] == getpurchaseorder('Enquirycurrency', $_REQUEST['purchid'])) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo $fdepart['Currency_Name']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label>Payment Terms <span style="color:#FF0000;"> *</span></label>
                                    <select name="paymentterms" id="paymentterms" required="required" class="form-control">
                                        <option value="">Select</option>
                                        <?php
                                        $dterms = $db->prepare("SELECT * FROM `payment_term` WHERE `Status`=?");
                                        $dterms->execute(array('1'));
                                        while ($fdepart = $dterms->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $fdepart['PID']; ?>"
                                            <?php
                                            if ($fdepart['PID'] == getpurchaseorder('Paymentterms', $_REQUEST['purchid'])) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo $fdepart['PaymentTerm']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <label>Enquiry Type <span style="color:#FF0000;"> *</span></label>
                                    <select name="enquirytype" id="enquirytype" required="required" class="form-control">
                                        <option value="">Select</option>
                                        <?php
                                        $dterms = $db->prepare("SELECT * FROM `enquiry` WHERE `Status`=?");
                                        $dterms->execute(array('1'));
                                        while ($fdepart = $dterms->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $fdepart['EID']; ?>"
                                            <?php
                                            if ($fdepart['EID'] == getpurchaseorder('Enquirytype', $_REQUEST['purchid'])) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo $fdepart['EnquiryType']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="vessel" id="vessel" required="required" class="form-control">
                                        <option value="">Select</option>
                                        <?php
                                        $dterms = $db->prepare("SELECT * FROM `vessel` WHERE `Status`=?");
                                        $dterms->execute(array('1'));
                                        while ($fdepart = $dterms->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $fdepart['VID']; ?>"
                                            <?php
                                            if ($fdepart['VID'] == getpurchaseorder('Vessel', $_REQUEST['purchid'])) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo $fdepart['Vessel']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    <label>Sales Rep <span style="color:#FF0000;"> *</span></label>
                                    <select name="salesrep" id="salesrep" required="required" class="form-control">
                                        <option value="">Select</option>
                                        <?php
                                        $dterms = $db->prepare("SELECT * FROM `employee` WHERE `Status`=?");
                                        $dterms->execute(array('1'));
                                        while ($fdepart = $dterms->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $fdepart['EmpID']; ?>"
                                            <?php
                                            if ($fdepart['EmpID'] == getpurchaseorder('Salesrep', $_REQUEST['purchid'])) {
                                                echo 'selected="selected"';
                                            }
                                            ?>><?php echo $fdepart['EmpName']; ?></option>
                                                <?php } ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                                ...
                                <table class="table table-bordered" id="customFieldss">
                                    <thead>
                                        <tr valign="top">
                                            ...
                                            <th style="width:7% ">Pack&nbsp;Rate(<i class="fa fa-inr"></i>)</th>
                                            <th style="width:7% ">Item&nbsp;Rate(<i class="fa fa-inr"></i>)</th>
                                            <th style="width:10%">Tax</th>
                                            <th style="width:1%">Taxable&nbsp;Amt</th>
                                            <th style="width:5%">Tax&nbsp;Amt</th>
                                            <th style="width:6%">Net&nbsp;Amt(<i class="fa fa-inr"></i>)</th>
                                            <th style="width:2%"></th>
                                        </tr>
                                    </thead>
                                    <tbody id="customFields">
                                        <?php
                                        if ($_REQUEST['purchid'] != '') {
                                            $getponumber = getpurchaseorder('PONumber', $_REQUEST['purchid']);
                                            //echo "SELECT * FROM `purchase_order_details` WHERE `PoNum` = $getponumber AND `PoID` ='" . $_REQUEST['purchid'] . "'";
                                            $getitemvalue = $db->prepare("SELECT * FROM `purchase_order_details` WHERE `PoNum` = ? AND `PoID` =?");
                                        ...
                                        <div class="col-md-12">
                                            <span >
                                                ...
                                                <span id='subtotaldisplay'><?php
                                                    if ($_REQUEST['purchid'] != '') {
                                                        echo number_format((float) getpurchaseorder('SubTotal', $_REQUEST['purchid']), 2, '.', '');
                                                    }
                                                    ?></span>
                                        ...
                                        <div class="col-md-12">
                                            <span>
                                                ...
                                                <span id='taxdisplay'><?php
                                                    if ($_REQUEST['purchid'] != '') {
                                                        echo number_format((float) getpurchaseorder('SubTaxTotal', $_REQUEST['purchid']), 2, '.', '');
                                                    }
                                                    ?></span>
                                        ...
                                        <div class="col-md-12">
                                            <span >
                                                ...
                                                <span id='NetAmtdisplay'><?php
                                                    if ($_REQUEST['purchid'] != '') {
                                                        echo number_format((float) getpurchaseorder('Total', $_REQUEST['purchid']), 2, '.', '');
                                                    }
                                                    ?></span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a id="printbutton"  target="_blank" class="btn btn-success fa fa-print" href="<?php echo $sitename . 'MPDF53/index.php?id=' . $_REQUEST['purchid'] . '&po=' . $purid; ?>"></a>
                                    <a id="emailbutton" class="btn btn-success fa fa-envelope-o" aria-hidden="true" data-toggle="modal" data-target="#EmailBox"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>process/purchase_order.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
...
<?php } ?>
    ...
    function addrow(itemid) {
        ...
        $.post("<?php echo $sitename; ?>pages/master/userajax.php", {supplier: supplierid, findkeyid: findid, selectitem: itemid},
                function (data)
                {
