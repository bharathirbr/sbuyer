...
$getmanuf = $db->prepare("SELECT * FROM `rfq` ORDER BY `PoID` DESC");
$getmanuf->execute();
...
if (isset($_REQUEST['submit'])) {
    ...
    $msg = addrfq($invno, $billdate, $taxtype, $netpayamt, $subtotal, $subtaxtotal, $Item_name, $suppliergird, $Qty, $Pack_UOM, $Pack_qty, $Item_UOM, $Total_Qty, $Pack_Rate, $Item_Rate, $tax, $Taxable_Amt, $Net_Amt, $Tax_Amt, $purchase_detailid, $ip, $deliveryterms, $modeofshipment, $enquirycurrency, $modeofpayment, $paymentterms, $enquirytype, $vessel, $salesrep, $CusID, $id);
}
?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>process/rfq.htm"><i class="fa fa-circle-o"></i>RFQ</a></li>
            <li class="active"><?php
                if ($_REQUEST['enquiryid'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form name="department" id="department" action="" method="post" enctype="multipart/form-data">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <label>RFQ No<span style="color:#FF0000;">*</span>
                                    </label>
                                    <input type="text" readonly class="form-control" placeholder="Enter the RFQ No" name="invno" id="invno" required="required" value="<?php
                                    if ($_REQUEST['enquiryid'] != '') {
                                        echo getrfq('PONumber', $_REQUEST['enquiryid']);
                                    } else {
                                        echo $purid;
                                    }
                                    ?>" />
                                ...
                                <div class="col-md-3">
                                    <label>RFQ Date<span style="color:#FF0000;"> *</span></label>
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" class="form-control pull-right usedatepicker" name="billdate" required="required"  value="<?php
                                        if (isset($_REQUEST['enquiryid']) && ( date('d-m-Y', strtotime(getrfq('PODate', $_REQUEST['enquiryid']))) != '01-01-1970')) {
                                            echo date('d-m-Y', strtotime(getrfq('PODate', $_REQUEST['enquiryid'])));
                                        }
                                        ?>" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select name="taxtype" id="taxtype" class="form-control" onchange="univaerselcha()">
                                        <option value="0" <?php
                                        if (getrfq('TaxType', $_REQUEST['enquiryid']) == '1') {
                                            echo 'selected';
                                        }
                                        ?>>No Tax</option>
                                        <option value="1" <?php
                                        ...
                                        <option value="2" <?php
                                        if (getrfq('TaxType', $_REQUEST['enquiryid']) == '2') {
                                            echo 'selected';
                                        }
                                        ?>>Excluded Tax</option>
                                    </select>
                                ...
                                <div class="col-md-3" id="suppliermode" >
                                    ...
                                    <div class="input-group date">
                                        <input type="text" readonly class="form-control"  name="customer" required="required" value="<?php echo getcustomer('Person', getrfq('CusID', $_REQUEST['enquiryid'])); ?>"/>
                                        <div class="input-group-addon">
                                ...
                                <div  style="display:none" id="supplierpanel">
                                    <input type="hidden" class="form-control"  name="CusID" id="CusID" required="required"value="<?php echo getrfq('CusID', $_REQUEST['enquiryid']); ?>"  />   
                                    <div class="col-md-3" >
                                    ...
                                    <div class="col-md-3" >
                                        ...
                                        <div class="col-md-9" >
                                            <label style="display: block !important ; font-size:20px;" id="compa_name"><?php echo getcustomer('Company', getrfq('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ;" id="supp_code">Supplier_code</label>
                                            <label style="display: block !important ;  font-weight:400  !important ;" id="supp_address"><?php echo getcustomer('Address_1', getrfq('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ; font-weight:400  !important ;" id="supp_state"><?php echo getcustomer('State', getrfq('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ; font-weight:400  !important ;" id="supp_city"><?php echo getcustomer('City', getrfq('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ; font-weight:400  !important ;" id="supp_county"><?php echo getcustomer('Country', getrfq('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ; font-weight:400  !important ;" id="supp_postcode"><?php echo getcustomer('Postcode   ', getrfq('CusID', $_REQUEST['enquiryid'])); ?></label>
                                        </div>
                                    </div>
                                </div><br/>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="customFieldss">
                                    ...
                                    <tbody id="customFields">
                                        <?php
                                        if ($_REQUEST['enquiryid'] != '') {
                                            $getponumber = getrfq('PONumber', $_REQUEST['enquiryid']);
                                            $getitemvalue = $db->prepare("SELECT * FROM `rfq_details` WHERE `PoNum` = ? AND `PoID` =?");
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>process/rfq.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
