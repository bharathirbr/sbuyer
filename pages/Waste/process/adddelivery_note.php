...
$getmanuf = $db->prepare("SELECT * FROM `delivery_note` ORDER BY `PoID` DESC");
$getmanuf->execute();
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>process/delivery_note.htm"><i class="fa fa-circle-o"></i>Delivery Note</a></li>
            <li class="active"><?php
                if ($_REQUEST['enquiryid'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form name="department" id="department" action="" method="post" enctype="multipart/form-data">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <label>DC No<span style="color:#FF0000;">*</span>
                                    </label>
                                    <input type="text" readonly class="form-control" placeholder="Enter the DC No" name="invno" id="invno" required="required" value="<?php
                                    if ($_REQUEST['enquiryid'] != '') {
                                        echo getdeliverynote('PONumber', $_REQUEST['enquiryid']);
                                    } else {
                                        echo $purid;
                                    }
                                    ?>" />
                                ...
                                <div class="col-md-3">
                                    <label>DC Date<span style="color:#FF0000;"> *</span></label>
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" class="form-control pull-right usedatepicker" name="billdate" required="required"  value="<?php
                                        if (isset($_REQUEST['enquiryid']) && ( date('d-m-Y', strtotime(getdeliverynote('PODate', $_REQUEST['enquiryid']))) != '01-01-1970')) {
                                            echo date('d-m-Y', strtotime(getdeliverynote('PODate', $_REQUEST['enquiryid'])));
                                        }
                                        ?>" >
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select name="taxtype" id="taxtype" class="form-control" onchange="univaerselcha()">
                                        <option value="0" <?php
                                        if (getdeliverynote('TaxType', $_REQUEST['enquiryid']) == '1') {
                                            echo 'selected';
                                        }
                                        ?>>No Tax</option>
                                        <option value="1" <?php
                                        ...
                                        <option value="2" <?php
                                        if (getdeliverynote('TaxType', $_REQUEST['enquiryid']) == '2') {
                                            echo 'selected';
                                        }
                                        ?>>Excluded Tax</option>
                                    </select>
                                ...
                                <div class="col-md-3" id="suppliermode" >
                                    ...
                                    <div class="input-group date">
                                        <input type="text" readonly class="form-control"  name="customer" required="required" value="<?php echo getcustomer('Person', getdeliverynote('CusID', $_REQUEST['enquiryid'])); ?>"/>
                                        <div class="input-group-addon">
                                ...
                                <div  style="display:none" id="supplierpanel">
                                    <input type="hidden" class="form-control"  name="CusID" id="CusID" required="required"value="<?php echo getdeliverynote('CusID', $_REQUEST['enquiryid']); ?>"  />   
                                    <div class="col-md-3" >
                                    ...
                                    <div class="col-md-3" >
                                        ...
                                        <div class="col-md-9" >
                                            <label style="display: block !important ; font-size:20px;" id="compa_name"><?php echo getcustomer('Company', getdeliverynote('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ;" id="supp_code">Supplier_code</label>
                                            <label style="display: block !important ;  font-weight:400  !important ;" id="supp_address"><?php echo getcustomer('Address_1', getdeliverynote('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ; font-weight:400  !important ;" id="supp_state"><?php echo getcustomer('State', getdeliverynote('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ; font-weight:400  !important ;" id="supp_city"><?php echo getcustomer('City', getdeliverynote('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ; font-weight:400  !important ;" id="supp_county"><?php echo getcustomer('Country', getdeliverynote('CusID', $_REQUEST['enquiryid'])); ?></label>
                                            <label style="display: block !important ; font-weight:400  !important ;" id="supp_postcode"><?php echo getcustomer('Postcode   ', getdeliverynote('CusID', $_REQUEST['enquiryid'])); ?></label>
                                        </div>
                                    </div>
                                </div><br/>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="customFieldss">
                                ...
                                <tbody id="customFields">
                                    <?php
                                    if ($_REQUEST['enquiryid'] != '') {
                                        $getponumber = getdeliverynote('PONumber', $_REQUEST['enquiryid']);
                                        $getitemvalue = $db->prepare("SELECT * FROM `delivery_note_details` WHERE `PoNum` = ? AND `PoID` =?");
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>process/delivery_note.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
...
<script>
	...
	function loaditemmap(){
		$.post('<?php echo $sitename; ?>pages/master/userajax.php', {show_selec_prod: '1', enq_id: '<?php echo $_REQUEST['enquiryid']; ?>'}, function (data) {
	...
	function loaditemrfqs(){
		$.post('<?php echo $sitename; ?>pages/master/userajax.php', {show_selec_supp: '1', enq_id: '<?php echo $_REQUEST['enquiryid']; ?>'}, function (data) {
