                    ...
                    <form name="rates_form" method="post" enctype="multipart/form-data"> 
                        <div class="box box-info" style="margin: 0;">
                            <div class="box-header with-border">
                                ...
                                $nds = $cur_rate->fetch();
                                ?>
                                <h3 class="box-title" style="width: 100%;">Rates Management (1 USD Values) <span style="float:right">Last updated time : <?php echo date("d-M-Y - h:i a (e T P)", strtotime($nds['date'])); ?></span></h3>
                            </div>
