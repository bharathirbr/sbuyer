                    ...
                    <div class="col-lg-9 col-md-9  col-main">
                        ...
                        <div class=" toolbar-products toolbar-top">
                            ...
                            <div class="modes">
                                ...
                                <a  href="{!! url('allcategories/list') !!}" title="List" class="modes-mode mode-list">
                                    <span>list</span>
                                </a>
                            </div><!-- View as -->
                            ...
                            <div class="toolbar-option">
                                ...
                                <form action="{{url('allcategories')}}" method="post">
                                     {{ csrf_field() }}
                            ...
                            <ol class="product-items row">
                                ...
                                <li class="col-sm-4 product-item product-item-opt-0">
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-detail">
                                            <strong class="product-item-name"><a href="{!! url('/'.$all_products->category->category_link.'/'.$all_products->subcategory->link.'/'.$all_products->link.'/'.$all_products->id) !!}">
                                                {{ $all_products->name }} </a></strong>
                                            <a href="{!! url('/'.$all_products->category->category_link.'/'.$all_products->subcategory->link.'/'.$all_products->link.'/'.$all_products->id) !!}"><div class="product-item-price">
