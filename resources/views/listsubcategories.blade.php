                    ...
                    <div class="col-lg-9 col-md-9  col-main">
                        ...
                        <div class=" toolbar-products toolbar-top">
                            ...
                            <div class="modes">
                                ...
                                <a  href="{!! url('/'.Request::segment(1)) !!}" class="modes-mode  mode-grid" title="Grid">
                                    <span>grid</span>
                                </a>
                            ...
                            <div class="toolbar-option">
                              <form action="{{ url('/'.Request::segment(1).'/list') }}" method="post">
                                     {{ csrf_field() }}
                   ...
                   @if(@$subcategory->count() > 0)
                        ...
                        <div class="products  products-list">
                            <ol class="product-items row">                               
                               ...
                               @foreach(@$subcategory as  $categories_page)  
                                 @foreach ($categories_page->product as $objects)
                               
                                <li class="col-sm-12 product-item product-item-opt-0">
                                    <div class="product-item-info">
                                        <div class="product-item-photo">
                                          <a href="{!! url('/'.$categories_page->category->category_link.'/'.$categories_page->link.'/'.$objects->link.'/'.$objects->id) !!}" class="product-item-img">
                                        <img src="{!! url('public/images/product/'.$objects->image) !!}" alt="" >   
                                        </a>
                                        </div>
                                        <div class="product-item-detail">
                                           <strong class="product-item-name">
                                                <a href="{!! url('/'.$categories_page->category->category_link.'/'.$categories_page->link.'/'.$objects->link.'/'.$objects->id) !!}">                                                
                                                        {{ $objects->name}}
                                                        </a></strong> <div class="product-item-review">
                                                <a href="" class="action">Wrire Your Rivew</a>
                                            </div>
                                            <div class="product-item-price">
                                                <a href="{!! url('/'.$objects->link) !!}"><span class="price">${{ @$objects->rate }}<a href="{!! url('/'.$objects->link) !!}"></span>
                                           </a> </div>
