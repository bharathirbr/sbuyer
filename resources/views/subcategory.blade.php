                    ...
                    <div class="col-lg-9 col-md-9  col-main">
                        ...
                        <div class=" toolbar-products toolbar-top">
                            ...
                            <div class="modes">
                                ...
                                <a  href="{!! url('/'.Request::segment(1).'/list') !!}" title="List" class="modes-mode mode-list">
                                    <span>list</span>
                                </a>
                            </div><!-- View as -->
                            ...
                            <ol class="product-items row">
                                ...
                                <li class="col-sm-4 product-item product-item-opt-0">
                                    <div class="product-item-info">
                                        ...
                                        <div class="product-item-detail">
                                            <strong class="product-item-name"><a href="{!! url('/'.$categories_page->category->category_link.'/'.$categories_page->link.'/'.$objects->link.'/'.$objects->id) !!}">                  
                                                        {{ $objects->name}}
                                                        </a>
                                            </strong>
