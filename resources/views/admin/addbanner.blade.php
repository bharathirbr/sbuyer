                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="portlet light ">
                                ...
                                <div>                            
                                    ...
                                    <div class="box-body">
                                <div class="portlet-body form">
                                    <form class="form-horizontal" name="banner" method="post" @if(@Request::segment(4) == '') action="{{url('admin/banner/add')}}" 
            @else action="{{ url('admin/banner/edit/'.Request::segment(4))}}" @endif   enctype="multipart/form-data" >
              {!! csrf_field() !!}
                                        <div class="form-body">
                                            ...
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" name="content" rows="6" data-error-container="#editor2_error">{{@$post->content}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="link" value="{{ @$post->link }}" class="form-control" placeholder="Enter Link">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="image_alt" value="{{ @$post->image_alt }}" class="form-control" placeholder="Enter Imagealt">
                                                @if (@$errors->has('image_alt'))
                                                        <label class="error">{{ @$errors->first('image_alt') }}</label>
                                                @endif
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="image_name" value="{{@$post->image_name}}" class="form-control" placeholder="Enter Imagename">
                                                    
                                                </div>
                                                 @if (@$errors->has('image_name'))
                                                        <label class="error">{{ @$errors->first('image_name') }}</label>
                                                @endif
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="{{ URL::to('/') }}/public/images/banners/{{ @$post->image}}" width="100" height="100" alt="{{ @$post->image_name }}" />
                                               @endif
                                                </div> 
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="order" value="{{@$post->order}}" class="form-control" placeholder="Enter order">
