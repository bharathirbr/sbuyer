                                    ...
                                    <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="category" class="form-control">
                                                        @for ($i = 0; $i <@$count; $i++)                                                        
                                                        <option value="{{@$faqall[$i]->id}}" @if(@$post->category_id == @$faqall[$i]->id) selected @endif>{{@$faqall[$i]->category_name}}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                        <input type="text" class="form-control input-inline input-medium" placeholder="Enter SubCategoryname" name="subcategory" value="{{@$post->subcategory}}" >
                                            ...
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" name="description" rows="6" data-error-container="#editor2_error">{{@$post->content}}</textarea>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Imagealt</label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Enter Imagealt" name="imagealt" value="{{@$post->imagealt}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Enter Imagename" name="imagename" value="{{@$post->imagename}}" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <!--  {{ comman_image::images('category/'.@$category->image ,@$category->image_title ,'100' ,'100','null') }} -->

                                                        <img src="{{ URL::to('/') }}/public/images/subcategory/{{ @$post->image}}" width="100" height="100" alt="{{ @$post->imagename }}" />
                                                        @endif
                                                    </div> 
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="menu" id="optionsRadios25" value="option1" @if(@$post->menu == 'option1') checked @endif> Show in Menu
                                                                   <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="menu" id="optionsRadios26" value="option2" @if(@$post->menu == 'option2') checked @endif> Show in HomePage
                                                                   <span></span>
                                                        </label>
                                                         @if (@$errors->has('menu'))
                                                          <label class="error">{{ @$errors->first('menu') }}</label>
                                                         @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="number" class="form-control" placeholder="Enter order" name="order"  value="{{@$post->order}}" >
                                                 @if (@$errors->has('order'))
