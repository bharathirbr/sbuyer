                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="portlet light ">
                                ...
                                <div>                            
                                    ...
                                    <div class="box-body">
                                <div class="portlet-body form">
            <form class="form-horizontal" name="banner" method="post" @if(@Request::segment(4) == '') action="{{url('admin/sidebanner/add')}}" 
            @else action="{{ url('admin/sidebanner/edit/'.Request::segment(4))}}" @endif   enctype="multipart/form-data" >
              {!! csrf_field() !!}
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    @if(@$post->image !='')
                                                     ...
                                                     <img src="{{ URL::to('/') }}/public/images/sidebanner/{{ @$post->image}}" width="100" height="100" alt="{{ @$post->image_name }}" />
                                                    @endif
                                                </div> 
                                            </div>
                                            ...
                                            <div class="col-md-6">                                                  
                                                    <select name="category" placeholder="Enter Categories">                                                   
                                                      @if(@$category->count() > 0 )
                                                      @foreach(@$category as $cate)                                                     
                                                      <option value="{{ @$cate->id }}" @if(@$post->category_id == @$cate->id) selected @endif > {{ @$cate->category_name }} </option>                             
                                                      @endforeach
                                                      @else
