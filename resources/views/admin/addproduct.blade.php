                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="portlet light ">
                                ...
                                @if (Session::has('category'))
                                    <div class="alert alert-success">{{ Session::get('title') }}
                                        @endif
                                    </div>
                                <div class="portlet-body form">
                                    <form class="form-horizontal" id="admin_product" class="admin_product" role="form" method="post" action="" enctype="multipart/form-data">
                                        <div class="form-body">                                      
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="categories" class="form-control">
                                                       ...
                                                       @foreach(@$category as $categ)
                                                        <option value="{{@$categ->id}}" @if(@$post->category_id == @$categ->id) selected @endif>
                                                         {{@$categ->category_name}}
                                                        </option>
                                                       @endforeach
                                                       @else
                                             ...
                                             <div class="form-group">
                                                <label class="col-md-3 control-label">Sub Categories</label>
                                                <div class="col-md-3">
                                                    <select name="subcategory" class="form-control">
                                                    @if(@$subcategory->count() > 0)
                                                       @foreach(@$subcategory as $casubcate)
                                                        <option value="{{@$casubcate->id}}" @if(@$post->subcategory_id == @$casubcate->id) selected @endif>
                                                         {{@$casubcate->subcategory}}
                                                        </option>
                                                    @endforeach
                                                    @else
                                                     <option value="">Please Add Sub Categories</option>
                                                    @endif
                                                </select>
                                                ...
                                                <div>
                                                 @if (@$errors->has('subcategory'))
                                                     <label class="error">{{ @$errors->first('subcategory') }}</label>
                                                  @endif
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    @if(@$brand->count() > 0)
                                                       @foreach(@$brand as $brand)
                                                        <option value="{{@$brand->id}}" @if(@$post->brand_id == @$brand->id) selected @endif>
                                                         {{@$brand->name}}
                                                        </option>
                                                    @endforeach
                                                    @else
                                                     <option value="">Please add brand</option>
                                                    @endif
                                                    </select>
                                                </div>
                                                <div>
                                                 @if (@$errors->has('brandname'))
                                                     <label class="error">{{ @$errors->first('brandname') }}</label>
                                                  @endif
                                                </div>
                                            </div>    
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                <input type="text" class="form-control input-inline input-medium" placeholder="Enter Product Name" name="name" value="{{@$post->name}}" >
                                                 <div>
                                                 @if (@$errors->has('name'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control input-inline input-medium" placeholder="Enter Title" name="title"  value="{{@$post->title}}">
                                                     <div>
                                                @if (@$errors->has('title'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control input-inline input-medium" placeholder="Enter Link" name="link"  value="{{@$post->link}}">                                                  
                                                     <div>
                                                      @if(Request::segment(3) == 'add')
                                                      ({{ url('/')}}/Maincategories/Subcategories/ )
                                                      @else                                                      
                                                      ({{ url('/').'/'.@$category_name[0].'/'.@$subcategory_name[0].'/'}})
                                                      @endif
                                            ...
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" name="description" rows="6" data-error-container="#editor2_error">{{@$post->description}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Enter Rate" name="rate" value="{{@$post->rate}}">
                                                    @if (@$errors->has('rate'))
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Min Price</label>
                                                <div class="col-md-6">
                                            <input type="text" class="form-control" placeholder="Enter Min Price" name="min_price" value="{{@$post->min_price}}">
                                                 @if (@$errors->has('min_price'))
                                                     <label class="error">{{ @$errors->first('min_price') }}</label>
                                                  @endif
                                                </div>
                                                 <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Enter Offer Price" name="offer_price" value="{{@$post->offer_price}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Enter Discount Price" name="discount_price" value="{{@$post->discount_price}}">
                                                </div>
                                            </div>    


                                             <div class="form-group">
                                                <label class="col-md-3 control-label">Product Image Title</label>
                                                <div class="col-md-6">
                                                 <input type="text" class="form-control" placeholder="Enter Image title" name="image_title" value="{{@$post->image_title}}">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Product Image alt</label>
                                                <div class="col-md-6">
                         <input type="text" class="form-control" placeholder="Enter image" name="image_alt" value="{{@$post->image_alt}}">
                                                </div>
                                            </div>                                           
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="metatitle" value="{{@$post->metatitle}}"  class="form-control" placeholder="Enter Meta Title">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="metakeyword" value="{{@$post->metakeyword}}"  class="form-control" placeholder="Enter Meta Keyword">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                            <textarea rows="4" cols="50" name="metadescription"  class="form-control" placeholder="Enter Meta Description"> {{@$post->metadescription}} </textarea>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="file" id="exampleInputFile" accept="image/*" name="image" value="{{@$post->image}}" >
                                                    <div class="form-group">

                                                        @if(!empty(@$post->image))                                                        
                                                        <label> Main Image : </label>                                                       
                                                        <img src="{{ URL::to('/') }}/public/images/product/{{ @$post->image}}" width="100" height="100" alt="{{ @$post->image }}" />
                                                        @endif
                                                        </div> 
                                                        @if (@$errors->has('image'))
                                              ...
                                              <div class="form-group">
                                                <label for="exampleInputFile" class="col-md-3 control-label">Product Extra Image</label>
                                                <div class="col-md-9">
                                                    <input type="file" id="exampleInputFile" name="extra_image[]" value="" multiple />
                                                    <div class="form-group">

                                                 @if(count(@$post->product_details) != '0')                                                   
                                                        @foreach($post->product_details as $imgname) 
                                                          
                                                        <img src="{{url('public/images/product/extra/'.$imgname->image)}}" max-width="90" height="90" alt="">
                                               ...
                                               <div class="form-group">
                                                <label class="col-md-3 control-label">Feature Product</label>
                                                <div class="col-md-6">
                                                  <input type="radio" name="featured_product" value="0" @if(@$post->featured_product == 0 ) checked @endif><label>No</label>
                                                  <input type="radio" name="featured_product" value="1" @if(@$post->featured_product == 1 ) checked @endif><label>Yes</label>
                                                </div>
                                            </div>
                                            

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Related Product(search)</label>
                                                <div class="col-md-6">
                                                <select name="releated_product[]" class="form-control" multiple>
                                                       @if(count(@$all_product) !='0')
                                                       @foreach(@$all_product as $categ)
                                                        <option value="{{@$categ->id}}">
                                                         {{@$categ->name}}
                                                        </option>
                                                       @endforeach
                                                       @else
                                                         <option value="">Please Insert Product</option>
                                                       @endif                                                        
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    @if (request::segment(3)=='add') 
                                                    <button type="submit" class="btn green" style="float:right">Submit</button>
                                                    @else
