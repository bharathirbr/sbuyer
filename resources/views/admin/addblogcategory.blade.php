                                                ...
                                                <form class="form-horizontal" role="form"  method="post" action="" enctype="multipart/form-data">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group last">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea class="ckeditor form-control" name="editor2" rows="6" data-error-container="#editor2_error">{{@$post->content}}</textarea>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <textarea name="metakeywords" class="form-control" id="metakeywords" placeholder="Enter The Meta Keywords">{{@$post->metakeyword}}</textarea>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <textarea name="metadescription" class="form-control" id="metadescription" placeholder="Enter The Meta Description">{{@$post->metadescription}}</textarea>
