...
<!--        <link href="../assets/layouts/layout2/css/custom.min.css" rel="stylesheet" type="text/css" />-->
	...
	<div class="alert alert-success">{{ Session::get('question') }}</div>
@endif
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">FAQ Question</label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Enter question" name="question" value="{{@$post->question}}" required>
                                           ...
                                           <div class="form-group last">
                                                <label class="control-label col-md-3">FAQ Answer
                                                    
                                                    
                                                </label>
                                                <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" name="editor2" rows="6" data-error-container="#editor2_error">{{@$post->answer}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Enter order" name="order" value="{{@$post->order}}" required>
