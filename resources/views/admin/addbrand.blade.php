...
<!--                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active">
                                                <input type="radio" name="options" class="toggle" id="option1">Add New Banner</label>
                                            
                                        </div>
                                    </div>-->
                                </div>
                                <div class="portlet-body form">                                   
                                        <form class="form-horizontal" name="brand" method="post" action=""   enctype="multipart/form-data" >
              {!! csrf_field() !!}
                                        <div class="form-body">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="title" value="{{ @$post->title }}" class="form-control" placeholder="Enter Title">  @if (@$errors->has('title'))
                                            ...
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div id="editor2_error">  @if (@$errors->has('content'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="file" name="image" id="exampleInputFile" accept="image/*">
                                                     @if(@$post->image !='') 
                                                     <img src="{{ URL::to('/') }}/public/images/brand/{{ @$post->image}}" width="100" height="100" alt="{{ @$post->image_name }}" />
                                                     @endif
                                                    @if (@$errors->has('image'))
