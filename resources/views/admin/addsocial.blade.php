                                        ...
                                        <div class="form-body">
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="class" value="{{ @$post->class }}" class="form-control" placeholder="Enter class">  @if (@$errors->has('class'))
                                                        <label class="error">{{ @$errors->first('class') }}</label>
                                                @endif                                                   
                                                </div>                                                
                                            </div>
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="link" value="{{ @$post->link }}" class="form-control" placeholder="Enter link">  @if (@$errors->has('link'))
