                                ...
                                <div class="filter-options-item filter-options-categori">
                                    ...
                                    @foreach($allgategories as $allgate)
                                        <ol class="items">
                                            <li class="item ">
                                                <label>
                                                    <input type="checkbox"><span>{{ $allgate->category_name}}</span>
                                                </label>
                                            </li>                                           
                                        </ol>
                                    @endforeach
                    ...
                    <div class="col-lg-9 col-md-9  col-main">
                        ...
                        <div class=" toolbar-products toolbar-top">
                            ...
                            <div class="modes">
                                ...
                                <a  href="{!! url('product/list') !!}" title="List" class="modes-mode mode-list">
                                    <span>list</span>
                                </a>
                            </div><!-- View as -->
                        ...
                        <div class="products  products-grid">
                            <ol class="product-items row">
                                ...
                                <li class="col-sm-4 product-item product-item-opt-0">
                                    <div class="product-item-info">
                                        <div class="product-item-photo">
                                            <a href="{!! url('product/'.$all_products->category->category_link.'/'.$all_products->subcategory->link.'/'.$all_products->id) !!}" class="product-item-img">
                                        <img src="{{ url('public/images/product/'.$all_products->image) }} " alt="" >                                    
                                       
                                            </a>
                                        </div>
                                        <div class="product-item-detail">
                                            <strong class="product-item-name"><a href="{!! url('product/'.$all_products->category->category_link.'/'.$all_products->subcategory->link.'/'.$all_products->id) !!}">
                                                {{ $all_products->name }} </a></strong>
                                            <a href="{!! url('product/'.$all_products->category->category_link.'/'.$all_products->subcategory->link.'/'.$all_products->id) !!}"><div class="product-item-price">
                                                <span class="price">₹{{ $all_products->rate }}</span>
                                            </div></a>
                                            <div class="product-item-actions">
                                                <a href="{{ url('addItem/'.$all_products->id) }}"><button class="btn btn-cart" type="button"><span>Add to Cart</span></button></a>
                                                <a href="{{ url('wishlist/'.$all_products->id) }}" class="btn btn-wishlist"><span>wishlist</span></a>
