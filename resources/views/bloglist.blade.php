                                ...
                                <div class="col-sm-12 post-item">                                    
                                    ...
                                    <div class="post-item-info">
                                        <div class="post-item-photo">
                                            ...
                                            <a href="{{ url('/blog/'.$value->blog->link.'/'.$value->link)}}" ><img width="417" height="237" src="{{ url('public/images/blog/'.$value->image) }}" alt="{!!$value->imagename !!}"></a>
                                        </div>
                        ...
                        <div class="sidebar-blog">
                            ...
                            <div class="block block-categori-blog">
                                ...
                                <div class="block-content">
                                    @foreach($Blogcategory_all as $key => $value)
